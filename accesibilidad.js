...
<style>
    ...
    #btn-accesibilidad-fijo {
        ...
        background: linear-gradient(135deg, #E37C3A 0%, #d96b2a 100%) !important;
    ...
    #btn-accesibilidad-fijo:hover {
        ...
        box-shadow: 0px 8px 25px rgba(227, 124, 58, 0.6) !important;
    }
    
    #btn-accesibilidad-fijo:active {
    ...
    #panel-accesibilidad-fijo {
        ...
        border: 3px solid #E37C3A !important;
    ...
    .acc-header {
        ...
        border-bottom: 2px solid #E37C3A !important;
    }
    ...
    .btn-acc-opcion:hover {
        background: #E37C3A !important;
        color: white !important;
        border-color: #E37C3A !important;
        transform: translateX(-3px) !important;
    }
    
    .btn-acc-opcion.activo {
        background: #d4edda !important;
        border-color: #28a745 !important;
        color: #155724 !important;
    }
    
    .btn-acc-opcion .icono {
        font-size: 18px !important;
        margin-right: 8px !important;
    }
    
    .btn-acc-opcion .check {
        display: none !important;
        color: #28a745 !important;
        font-weight: bold !important;
    }
    
    .btn-acc-opcion.activo .check {
...
<button id="btn-accesibilidad-fijo" onclick="window.toggleMenuAcc()" aria-label="Menú de accesibilidad">
    ♿
    <span id="contador-activas">0</span>
</button>

<div id="panel-accesibilidad-fijo" role="dialog" aria-label="Panel de accesibilidad">
    <div class="acc-header">
        <strong>♿ Accesibilidad</strong>
        <button class="acc-close" onclick="window.toggleMenuAcc()" aria-label="Cerrar menú">×</button>
    </div>
    
    <div class="acc-section">
        <div class="acc-section-title">📏 Tamaño de texto</div>
        <div class="zoom-controls">
            <button class="btn-acc-opcion" onclick="window.cambiarZoom(0.9)" data-opcion="zoom-menos">
                <span><span class="icono">➖</span> Reducir</span>
            </button>
            <button class="btn-acc-opcion" onclick="window.cambiarZoom(1)" data-opcion="zoom-normal">
                <span><span class="icono">🏠</span> Normal</span>
            </button>
            <button class="btn-acc-opcion" onclick="window.cambiarZoom(1.2)" data-opcion="zoom-mas">
                <span><span class="icono">➕</span> Aumentar</span>
            </button>
        </div>
    </div>
    
    <div class="acc-section">
        <div class="acc-section-title">🎨 Visual</div>
        <button class="btn-acc-opcion" onclick="window.toggleContrasteAlto()" data-opcion="contraste">
            <span><span class="icono">🌗</span> Alto contraste</span>
            <span class="check">✓</span>
        </button>
        <button class="btn-acc-opcion" onclick="window.toggleModoOscuro()" data-opcion="oscuro">
            <span><span class="icono">🌙</span> Modo oscuro</span>
            <span class="check">✓</span>
        </button>
        <button class="btn-acc-opcion" onclick="window.toggleResaltarEnlaces()" data-opcion="enlaces">
            <span><span class="icono">🔗</span> Resaltar enlaces</span>
            <span class="check">✓</span>
        </button>
    </div>
    
    <div class="acc-section">
        <div class="acc-section-title">📖 Legibilidad</div>
        <button class="btn-acc-opcion" onclick="window.toggleFuenteDislexia()" data-opcion="dislexia">
            <span><span class="icono">🔤</span> Fuente dislexia</span>
            <span class="check">✓</span>
        </button>
        <button class="btn-acc-opcion" onclick="window.toggleEspaciado()" data-opcion="espaciado">
            <span><span class="icono">📏</span> Más espaciado</span>
            <span class="check">✓</span>
        </button>
    </div>
    
    <div class="acc-section">
        <div class="acc-section-title">⚡ Animaciones</div>
        <button class="btn-acc-opcion" onclick="window.togglePausarAnimaciones()" data-opcion="animaciones">
            <span><span class="icono">⏸️</span> Pausar animaciones</span>
            <span class="check">✓</span>
        </button>
    </div>
    
    <button class="btn-acc-opcion btn-reset" onclick="window.resetTodo()">
        <span><span class="icono">🔄</span> Restablecer todo</span>
    </button>
</div>
`;
...
function marcarActivo(opcion) {
    const btn = document.querySelector(`[data-opcion="${opcion}"]`);
...
function toggleOpcion(nombre, clase) {
    const activo = document.documentElement.classList.toggle(clase);
    const btn = document.querySelector(`[data-opcion="${nombre}"]`);
