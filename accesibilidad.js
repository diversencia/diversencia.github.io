(function() {
    ...
    function cargarConfiguracion() {
        ...
        if (zoom) {
            document.body.classList.remove('zoom-90', 'zoom-120');
            if (zoom === '0.9') {
                document.body.classList.add('zoom-90');
                marcarActivo('zoom-menos');
            } else if (zoom === '1.2') {
                document.body.classList.add('zoom-120');
                marcarActivo('zoom-mas');
            } else {
                marcarActivo('zoom-normal');
            }
        }
