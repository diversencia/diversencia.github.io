const crearMenu = () => {
  ...
  <style>
    ...
    .hamburguesa {
      ...
      z-index: 1000;
      cursor: pointer;
      background-color: #e37c3a !important; /* Color verde */
      border: none;
      padding: 12px 8px;
    ...
    .hamburguesa:focus, .hamburguesa:active {
      background-color: #e37c3a !important;
    }

    .hamburguesa:hover {
      background-color: ##86ae87 !important; /* Naranja */
    }
    ...
    <div class="menu-wrapper" id="menu-wrapper">
      <nav class="menu-lateral">
        ...
        <ul id="lista-menu">
          ...
          <li><a href="recomendar.html">Recomendaciones multimedia</a><span class="asterisco-activo">*</span></li>
